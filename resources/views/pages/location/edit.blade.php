    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="locModalEditLabel">Pos Patroli</h1>
                ...
                <form method="POST" action="" id="formEdit">
                    ...
                    <div class="w-full max-w-full px-3 shrink-0 md:flex-0">
                        <div class="mb-4 flex flex-col relative">
                            ...
                            <input type="text" name="location_name" id="location_name" value="{{ $location->location_name ?? '' }}" required autofocus
